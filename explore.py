...
def scaling(train = pr.tvt_split(target = None)[0], validate = pr.tvt_split(target = None)[1], test = pr.tvt_split(target = None)[2], scaler_type = sklearn.preprocessing.StandardScaler()):
    """
...
def plot_categorical_and_continuous_vars():
    ...
    '''
    df = scaling(train = pr.tvt_split(target = None)[0], validate = pr.tvt_split(target = None)[1], test = pr.tvt_split(target = None)[2])[0]
...
def explore_univariate(train = pr.tvt_split(target = None)[0], cat_vars = separate_feats(pr.tvt_split(target = None)[0])[1], quant_vars = separate_feats(pr.tvt_split(target = None)[0])[2]):
    for var in cat_vars:
...
def explore_bivariate(train = pr.tvt_split(target = None)[0], target = 'tax_value', cat_vars = separate_feats(pr.tvt_split(target = None)[0])[1], quant_vars = separate_feats(pr.tvt_split(target = None)[0])[2]):
    for cat in cat_vars:
        explore_bivariate_categorical(train, target, cat)
    for quant in quant_vars:
        explore_bivariate_quant(train, target, quant)

def explore_multivariate(train = pr.tvt_split(target = None)[0], target = 'tax_value', cat_vars = separate_feats(pr.tvt_split(target = None)[0])[1], quant_vars = separate_feats(pr.tvt_split(target = None)[0])[2]):
    '''
    '''
